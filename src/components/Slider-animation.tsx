...
import { ChevronLeft, ChevronRight, Play, Pause, ArrowDown, Sparkles, Zap, Shield, Award } from 'lucide-react';
  ...
  const slides = [
    {
      ...
      title: "Innovative Solutions in",
      highlightWords: ["Plastic", "Engineering"],
      subtitle: "Transforming industries with cutting-edge plastic solutions that combine durability, sustainability, and innovation. Leading the way in plastic manufacturing excellence since 2005.",
    ...
    },
    {
      ...
      highlightWords: ["Technology", "Excellence"],
      subtitle: "State-of-the-art facilities equipped with cutting-edge technology to deliver precision-engineered plastic components that exceed industry standards and customer expectations.",
    ...
    },
    {
      ...
      highlightWords: ["Reliability", "Trust"],
      subtitle: "Rigorous quality control processes and industry-leading certifications ensure every product meets the highest standards of performance, safety, and environmental responsibility.",
      gradient: "from-black/80 via-green-900/60 to-black/70",
      accentColor: "text-emerald-400",
      icon: Shield,
      primaryBtn: "Quality Standards",
      secondaryBtn: "Certifications"
    },
    {
      id: 4,
      ...
      highlightWords: ["Awards", "Leadership"],
      subtitle: "Recognized globally for innovation, sustainability, and excellence in plastic engineering. Our commitment to pushing boundaries has earned trust from industry leaders worldwide.",
      ...
      <div className="absolute top-8 left-8 z-20">
        <div className="bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 border border-white/20">
          <div className="text-white font-bold text-xl tracking-wider">
            PLASTEX
            <div className="text-xs font-normal opacity-75">Engineering Excellence</div>
          </div>
        </div>
      </div>

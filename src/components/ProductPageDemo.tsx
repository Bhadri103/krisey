    ...
    >
      ...
      <div className="p-4 md:p-5 flex flex-col flex-grow">
        ...
        <button
          ...
          className="mt-auto w-full flex items-center justify-center gap-2 bg-red-600 text-white text-xs md:text-sm font-medium py-2 md:py-2.5 rounded-xl hover:bg-red-700 transition-colors duration-300"
        >
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          {/* Page title */}
           <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-base md:text-lg text-gray-500 max-w-2xl mx-auto">
              Quality over quantitys - High-performance construction materials engineered for the modern world.
            </p>
          </div>
          ...
          {/* ── Ceramikha Products ───────────────────────────────────────────── */}
          <div className="mb-20 bg-white rounded-3xl p-6 md:p-10 shadow-sm border border-gray-100">
            <SectionHeader
              accent="CERAMIKHA"
              label=" Products"
          ...
          <div className="mb-20">
            <SectionHeader
              accent="Finishing"
              label=" Products"
              subtitle="Tile Adhesives, Pre Mix & Waterproofing Solutions"
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Why Choose <span className="text-red-600">Dallas?</span>
            </h2>
